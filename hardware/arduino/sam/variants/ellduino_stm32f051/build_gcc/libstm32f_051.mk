...
CHIP=__STM32F051__
VARIANT=ellduino_stm32f051
LIBNAME=libstm32f_051
TOOLCHAIN=gcc
...
PROJECT_BASE_PATH = ..
SYSTEM_PATH = ../../../system/
CMSIS_PATH = $(SYSTEM_PATH)/CMSIS
CMSIS_INCLUDE_PATH=$(CMSIS_PATH)/CMSIS/Include
SYSTEM_SOURCE_PATH=$(SYSTEM_PATH)/libstm32f/source
SYSTEM_INCLUDE_PATH=$(SYSTEM_PATH)/libstm32f/include
...
vpath %.cpp $(PROJECT_BASE_PATH) $(SYSTEM_SOURCE_PATH)

VPATH+=$(PROJECT_BASE_PATH) $(SYSTEM_SOURCE_PATH)
...
INCLUDES += -I$(SYSTEM_INCLUDE_PATH)
INCLUDES += -I$(CMSIS_INCLUDE_PATH)
...
#-------------------------------------------------------------------------------
C_SRC=$(wildcard $(PROJECT_BASE_PATH)/*.c) $(wildcard $(SYSTEM_SOURCE_PATH)/*.c)
...
#-------------------------------------------------------------------------------
CPP_SRC=$(wildcard $(PROJECT_BASE_PATH)/*.cpp) $(wildcard $(SYSTEM_SOURCE_PATH)/*.cpp)
...
#-------------------------------------------------------------------------------
A_SRC=$(wildcard $(PROJECT_BASE_PATH)/*.s) $(wildcard $(SYSTEM_SOURCE_PATH)/*.s)
